          ...
          <div ref={tiltRef} className="lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0 perspective-1000">
            ...
            >
              <div ref={imgWrapRef} className="relative animate-float preserve-3d will-change-transform">
                ...
                <div className="hidden md:block absolute inset-0 pointer-events-none animate-orbit" style={{ animationDuration: "20s", animationDirection: "reverse" }}>
                ...
                <div className="hidden md:block absolute inset-0 pointer-events-none animate-orbit" style={{ animationDuration: "30s" }}>
                ...
                <div className="hidden md:block absolute inset-0 pointer-events-none animate-orbit" style={{ animationDuration: "24s", animationDirection: "reverse" }}>
                ...
                <div className="hidden md:block absolute -top-2 left-1/3 w-2 h-2 bg-accent rounded-full animate-ping opacity-60" style={{ animationDelay: "0.7s" }} />
                <div className="hidden md:block absolute bottom-6 -left-3 w-2.5 h-2.5 bg-primary-glow rounded-full animate-ping opacity-70" style={{ animationDelay: "1.4s" }} />
                <div className="hidden md:block absolute -bottom-1 right-1/4 w-2 h-2 bg-accent rounded-full animate-ping opacity-60" style={{ animationDelay: "2.1s" }} />
